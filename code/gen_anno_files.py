...
def annotation_file_train_test(image_dir, valid_size, random_seed=42):
    file_paths=[]
    lables = []
    train_file_name = "malimg_train_2_24"+str(valid_size)+".csv"
    test_file_name = "malimg__test_2_24" + str(valid_size)+".csv"
    class_weight_name = "malimg_class_2_24" + str(valid_size)+".csv"
